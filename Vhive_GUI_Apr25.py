...
def getnewWebcam():
    ...
    pygame.init()
    pygame.camera.init()
    cam = pygame.camera.Camera("/dev/video0", (cam_w,cam_h))
    cam.start()

    #setup window
    windowSurfaceObj = pygame.display.set_mode((cam_w, cam_h), 1, 16)
    ...
    #display the picture in new window
    #(not needed for GUI integration):
    catSurfaceObj = image
